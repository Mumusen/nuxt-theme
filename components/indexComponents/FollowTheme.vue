    ...
    <div class="followContent">
        <ul class="followContainer" >
            <li v-for="followTheme in followThemeList">
                <div v-if="followTheme.left" :class="followTheme.left?followTheme.left.style:''" 
                    @click="jumpThemeDetails({
                        id: followTheme.id
                    })"
                >
                    <span>{{followTheme.left?followTheme.left.value:''}}</span>
                    <span>{{followTheme.left?followTheme.left.themeName:''}}</span>
                </div>
                <div class="follow-r" v-if="followTheme.right"> 
                    <div class="t-title">
                        <span>
...
export default {
    ...
    methods: {
        ...
        jumpStockDetails(obj){
            ...
            window.open(`/stockDetails?code=${id}&name=${encodeURI(name)}`);
            // this.$router.push({
