    ...
    <div class="col col-md-8 leftUnit" style="padding-right:0" >
        <div  v-for="plateInfo in marketIndexData.market" class="unit">
            ...
            <div class="block right">
                ...
                <div class="bottom">
                    <span :class="plateInfo.currentPrice>=0?'textRed':'textGreen'">
                        {{formaterNum(plateInfo.currentPrice) >=0?'+'+formaterNum(plateInfo.currentPrice):formaterNum(plateInfo.currentPrice)}}
                    </span>
                    <span :class="plateInfo.changeRate>=0?'textRed':'textGreen'">
                        {{formaterNum(plateInfo.changeRate)>=0?'+'+formaterNum(plateInfo.changeRate):formaterNum(plateInfo.changeRate)}}%
                    </span>
                </div>
            </div>
        </div>
