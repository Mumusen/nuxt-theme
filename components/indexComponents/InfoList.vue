            ...
            <div v-for="(info, index) in infos.data" class="row" style="margin:0;">
                <div class="col col-md-11 col-md-offset-1 unit">
                    ...
                    <div class="themeArea">
                        ...
                        >
                        <!-- @click="jumpThemeDetail(info.conceptStockInfo.id)" -->
                            <span v-if="info.conceptStockInfo"> <a href="javascript:;"  class="textRed">{{info.conceptStockInfo.conceptStockName}}</a></span>
                            <b v-if="info.isTop === '1'"></b>
                        </div>
                        <div class="t-content">
                            <p>
                                <b style="margin-right: 15px;font-weight: bold;">{{info.infomationName}}</b>
                                <!-- 120 -->
...
export default {
    ...
    methods: {
        ...
        jumpStockDetail(obj){
            ...
            window.open(`/stockDetails?code=${stockCode}&name=${encodeURI(stockName)}`);
            // this.$router.push({
