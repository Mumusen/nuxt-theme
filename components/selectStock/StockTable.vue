        ...
        <table>
            ...
            <tbody v-if="optional && optional.mySelect">
                <tr v-for="list in optional.mySelect">
                    ...
                    <td v-if="list.infoType === 1"> 
                        <nuxt-link 
                            :to="'/stockDetails?name='+wordEncodeURI(list.infoName)+'&code='+list.infoCode+'&marketCode='+list.dataType"
                            target="_blank"
                    ...
                    <td v-if="list.infoType === 0">
                        ...
                        <span v-for="stock in list.stockList">
                            <nuxt-link 
                                :to="'/stockDetails?name='+wordEncodeURI(stock.name)+'&code='+stock.code" target="_blank"
