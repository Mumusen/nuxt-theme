        ...
        <table>
            ...
            <tbody v-if="stockListTable && stockListTable.length !== 0" v-for="stock in stockListTable" style="background: #fff;border-right: 1px solid #dedede;border-bottom: 1px solid #dedede">
                <tr >
                    ...
                    <td> 
                        <nuxt-link 
                            :to="'/stockDetails?name='+wordEncodeURI(stock.oneData.secu_abbr)+'&code='+stock.oneData.stockCode" target="_blank"
                        >
                ...
                <tr v-for="differ in stock.data">
                    ...
                    <td><nuxt-link 
                            :to="'/stockDetails?name='+wordEncodeURI(differ.secu_abbr)+'&code='+differ.stockCode" target="_blank"
