        ...
        <table>
            ...
            <tbody v-if="departmentTypeStockList && departmentTypeStockList.stockList && stockList_5day.len">
                <tr>
                    ...
                    <td> 
                        <nuxt-link
                            :to="'/stockDetails?name='+wordEncodeURI(stockList_5day.firstData.stockName)+'&code='+stockList_5day.firstData.stockCode" target="_blank"
                ...
                <tr v-for="stock in stockList_5day.data">
                    ...
                    <td> 
                        <nuxt-link
                            :to="'/stockDetails?name='+wordEncodeURI(stock.stockName)+'&code='+stock.stockCode" target="_blank"
        ...
        <table>
            ...
            <tbody v-if="departmentTypeStockList && departmentTypeStockList.stockList && stockList_10day.len">
                <tr>
                    ...
                    <td> 
                        <nuxt-link
                            :to="'/stockDetails?name='+wordEncodeURI(stockList_10day.firstData.stockName)+'&code='+stockList_10day.firstData.stockCode" target="_blank"
        ...
        <table>
            ...
            <tbody v-if="departmentTypeStockList && departmentTypeStockList.stockList && stockList_1month.len">
                <tr>
                    ...
                    <td> 
                        <nuxt-link
                            :to="'/stockDetails?name='+wordEncodeURI(stockList_1month.firstData.stockName)+'&code='+stockList_1month.firstData.stockCode" target="_blank"
        ...
        <table>
            ...
            <tbody v-if="departmentTypeStockList && departmentTypeStockList.stockList && stockList_3month.len">
                <tr>
                    ...
                    <td> 
                        <nuxt-link
                            :to="'/stockDetails?name='+wordEncodeURI(stockList_3month.firstData.stockName)+'&code='+stockList_3month.firstData.stockCode" target="_blank"
